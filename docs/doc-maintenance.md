...
| [`session-lifecycle.md`](./session-lifecycle.md) | Rules for creating and reusing `chat_sessions`, including orchestration child sessions, future issue/hook dispatch, and remote-execution ownership. |

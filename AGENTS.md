...
- [docs/session-lifecycle.md](docs/session-lifecycle.md) — rules for creating and reusing `chat_sessions`, including orchestration child sessions, future issue/hook dispatch, and remote-execution ownership.

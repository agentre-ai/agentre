...
var registry = []Definition{
	...
	{Key: KeyOrchestrate, MCPPath: "/mcp/orchestrate/", ToolNames: []string{"agent_list", "dispatch", "ask", "send", "finish", "reply", "report", "read", "status", "task_list", "task_add", "task_update"}},
